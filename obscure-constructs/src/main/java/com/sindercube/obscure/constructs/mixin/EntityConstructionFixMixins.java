...
import com.sindercube.obscure.constructs.access.ObscureEntityAccess;
...
public class EntityConstructionFixMixins {
	...
	public abstract static class WitherEntityMixin extends Entity implements ObscureEntityAccess {
